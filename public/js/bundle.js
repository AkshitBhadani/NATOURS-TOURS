...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "'pk.eyJ1IjoiYWtzaGl0MTIzIiwiYSI6ImNsdDZ1NjVtNTBmdnUybG1zNGtqeHk1NXIifQ.BGLLJIaoteO0ia2EXIiWgQ'";
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          try {
            ...
            url = "http://localhost:3000/check/".concat(tourId);
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addreview.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addreviewform = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var addreviewform = exports.addreviewform = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(addreview, rating, datetime) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
  ...
  return function addreviewform(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
var forgot_Password = document.querySelector(".forgotpassword");
...
if (userReviewForm) userReviewForm.addEventListener("submit", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var addreview, rating, datetime;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          document.querySelector(".btn--save-rating").textContent = "Updating...";
          addreview = document.getElementById("addreview").value;
          rating = document.getElementById("rating").value;
          datetime = document.getElementById("datetime").value;
          _context.next = 7;
          return (0, _addreview.addreviewform)({
            addreview: addreview,
            rating: rating,
            datetime: datetime
          }, "data");
...
if (forgot_Password) forgot_Password.addEventListener("submit", /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          passwordConfirm = document.getElementById("passwordConfirm").value;
          _context5.next = 6;
          return (0, _resetPassword.resetPassword)(password, passwordConfirm);
        case 6:
          document.querySelector(".btn--green").textContent = "Success";
          document.getElementById("password").value = "";
          document.getElementById("passwordConfirm").value = "";
